...
> 2. There are already some great meeting series in this area.
> 3. However, research talks and journal clubs are typically focused on research, and
     not on the tools and methods used along the way.
> 4. It's very likely that many people are solving the same problems, indepdendently
>    throughout NIH.
...
> - Debugging Python code using IPython + PDB
...
on [Github](https://github.com/nih-byob/presentations).
...
![Slack](assets/img/google-groups.png)
